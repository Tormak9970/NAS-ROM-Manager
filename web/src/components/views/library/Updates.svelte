<script lang="ts">
  ...
  import { romUpdates } from "@stores/State";
  ...
  const type = ExtraFileType.UPDATE;
...
<div>
  ...
  <div class="update-files">
    ...
    {:else}
      <div class="message-container">No updates found for this game.</div>
    {/each}
  </div>
</div>
